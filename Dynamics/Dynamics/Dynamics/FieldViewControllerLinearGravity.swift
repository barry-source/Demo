//
//  FieldViewControllerLinearGravity.swift
//  Dynamics
//
...
class FieldViewControllerLinearGravity: UIViewController {
    ...
    lazy var ballView: BallView = {
        let ballView = BallView(frame: CGRect(x: 0, y: 300, width: 50, height: 50))
